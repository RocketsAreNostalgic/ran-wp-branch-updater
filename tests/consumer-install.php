...
if ( ! class_exists( RAN\WPBranchUpdater\V1\BranchDeploymentPackage::class ) ) {
...
foreach ( array( RAN\WPBranchUpdater\V1\BranchDeploymentPackage::class, RAN\UpdaterSupport\V1\ArchiveSafety::class ) as $class ) {
...
$provider = new class implements RAN\WPBranchUpdater\V1\BranchProvider {

	public function prepare( RAN\WPBranchUpdater\V1\Deployment $deployment ): RAN\WPBranchUpdater\V1\ArchiveOffer {
...
$branches = $configure( $provider, new RAN\WPBranchUpdater\V1\FileAttemptStore( $state ), $consumer . '/private/archives' );
if ( ! $branches instanceof RAN\WPBranchUpdater\V1\BranchDeploymentPackage ) {
...
if ( ! $runner instanceof RAN\WPBranchUpdater\V1\BranchDeploymentOperation ) {
...
if (
	! $runnerFacts->getProperty( 'executor' )->getValue( $runner ) instanceof RAN\WPBranchUpdater\V1\WordPressPackageExecutor
	|| ! $runnerFacts->getProperty( 'lock' )->getValue( $runner ) instanceof RAN\WPBranchUpdater\V1\WordPressUpdaterLock
) {
